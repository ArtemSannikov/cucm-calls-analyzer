...
* _Предыдущий месяц_, _Текущий месяц_ - выводится статистика в виде текста со следующей инфомрацией: состоявщиеся и не состоявшиеся звонки, а так же сколько было звонков и их общая длительность).
