...
* Неактивные номера - от текущей дата отсчитывается 90 дней, и просматривается активность за этот промежуток. Если активность устройства была нулевая, выводится имя устройства и его номер.
* Предыдущий месяц - 
* Текущий месяц - 
