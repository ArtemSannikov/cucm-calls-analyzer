...
_В виде таблицы_ - выводится статистика в виде таблицы. Таблица содержит следующие поля:
...
_В виде текста_ - выводится статистика со следующей информацией: состоявшиеся и несостоявшиеся звонки, а так же подсчитывается их количество и общая длительность).
