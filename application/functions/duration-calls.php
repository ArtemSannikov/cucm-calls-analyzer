...
echo '<h3>Длительность разговоров</h3><hr/>';
...
$Count_Incoming_Call = mysql_query('SELECT SUM(`duration`) 
									FROM '.DB_TABLE.' 
									WHERE `callingPartyNumber` LIKE \'%_______\' 
...
$Count_Outgoing_Call_City_P1 = mysql_query('SELECT SUM(`duration`) 
											FROM '.DB_TABLE.' 
											WHERE `originalCalledPartyNumber` LIKE \'%343_______\' 
												  AND `dateTimeOrigination` >= '.$GLOBALS['begin_time'].' 
												  AND `dateTimeDisconnect` <= '.$GLOBALS['end_time']);

		$Result_COCC_P1 = mysql_result($Count_Outgoing_Call_City_P1, 0);

$Count_Outgoing_Call_City_P2 = mysql_query('SELECT SUM(`duration`) 
											FROM '.DB_TABLE.' 
											WHERE `originalCalledPartyNumber` LIKE \'_______\' 
												  AND `dateTimeOrigination` >= '.$GLOBALS['begin_time'].' 
												  AND `dateTimeDisconnect` <= '.$GLOBALS['end_time']);
					
	$Result_COCC_P2 = mysql_result($Count_Outgoing_Call_City_P2, 0);

$Count_Outgoing_Call_City_P3 = mysql_query('SELECT SUM(`duration`) 
											FROM '.DB_TABLE.' 
											WHERE `originalCalledPartyNumber` LIKE \'%80________\' 
												  AND `dateTimeOrigination` >= '.$GLOBALS['begin_time'].' 
												  AND `dateTimeDisconnect` <= '.$GLOBALS['end_time']);
...
$Count_Outgoing_Call_Smartphone = mysql_query('SELECT SUM(`duration`) 
											   FROM '.DB_TABLE.' 
											   WHERE `originalCalledPartyNumber` LIKE \'%9_________\' 
											  		 AND `dateTimeOrigination` >= '.$GLOBALS['begin_time'].' 
											  		 AND `dateTimeDisconnect` <= '.$GLOBALS['end_time']);
...
$Count_Outgoing_Call_Intercity_P1 = mysql_query('SELECT SUM(`duration`) 
												 FROM '.DB_TABLE.' 
												 WHERE `originalCalledPartyNumber` LIKE \'___________\' 
												 	   AND `dateTimeOrigination` >= '.$GLOBALS['begin_time'].' 
												 	   AND `dateTimeDisconnect` <= '.$GLOBALS['end_time']);
...
$Count_Conference_P1 = mysql_query('SELECT SUM(`duration`) 
									FROM '.DB_TABLE.' 
									WHERE `finalCalledPartyNumber` LIKE \'b%\' 
										  AND `dateTimeOrigination` >= '.$GLOBALS['begin_time'].' 
										  AND `dateTimeDisconnect` <= '.$GLOBALS['end_time']);

	$Result_CC_P1 = mysql_result($Count_Conference_P1, 0);

$Count_Conference_P2 = mysql_query('SELECT SUM(`duration`) 
									FROM '.DB_TABLE.' 
									WHERE `finalCalledPartyNumber` LIKE \'00%\' 
										  AND `dateTimeOrigination` >= '.$GLOBALS['begin_time'].' 
										  AND `dateTimeDisconnect` <= '.$GLOBALS['end_time']);

	$Result_CC_P2 = mysql_result($Count_Conference_P2, 0);

$Count_Conference_P3 = mysql_query('SELECT SUM(`duration`) 
									FROM '.DB_TABLE.' 
									WHERE `finalCalledPartyNumber` LIKE \'87___\' 
										  AND `dateTimeOrigination` >= '.$GLOBALS['begin_time'].' 
										  AND `dateTimeDisconnect` <= '.$GLOBALS['end_time']);
...
$Count_Internal_Calls_P1 = mysql_query('SELECT SUM(`duration`) 
										FROM '.DB_TABLE.' 
										WHERE (`callingPartyNumber` LIKE \'_____\') 
											  AND (`finalCalledPartyNumber` LIKE \'_____\') 
											  AND `dateTimeOrigination` >= '.$GLOBALS['begin_time'].' 
											  AND `dateTimeDisconnect` <= '.$GLOBALS['end_time']);
...
$Count_Video_Calls_P1 = mysql_query('SELECT SUM(`duration`) 
									 FROM '.DB_TABLE.' 
									 WHERE `destVideoCap_Codec` > 0 
									 	   AND `dateTimeOrigination` >= '.$GLOBALS['begin_time'].' 
									 	   AND `dateTimeDisconnect` <= '.$GLOBALS['end_time']);
